...
def model_Evaluate(model, model_name):
    ...
    plot_path = f'analysis_plots/confusion_matrix_{model_name}.png'
...
plt.savefig('analysis_plots/roc_curve_bnb.png', dpi=300, bbox_inches='tight')
...
plt.title('ROC CURVE')
plt.legend(loc="lower right")
plt.savefig('analysis_plots/roc_curve_lr.png', dpi=300, bbox_inches='tight')