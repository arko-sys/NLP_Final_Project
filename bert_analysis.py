...
plt.savefig('../NLP_Final_Project/analysis_plots/roc_curve_bert.png', dpi=300, bbox_inches='tight')
...
plt.savefig('../NLP_Final_Project/analysis_plots/confusion_matrix_bert.png', dpi=300, bbox_inches='tight')
